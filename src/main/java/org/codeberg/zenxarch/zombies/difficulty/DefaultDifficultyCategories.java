...
import org.codeberg.zenxarch.zombies.difficulty.category.PlayerDeathsCategory;
...
public interface DefaultDifficultyCategories {
  public static void initialize() {
    ...
    PlayerDeathsCategory.initialize();
    ...
    DifficultyCategory.addDifficultyStage(
        PlayerDeathsCategory.PLAYER_DEATHS_CATEGORY, (a, b) -> a * b);
  }
}
