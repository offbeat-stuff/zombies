...
public enum Period {
  ...
  public int getSpawnTries(double progress) {
    ...
    return (int)MathHelper.lerp(progress, spawnTries.get(index),
  ...
  public int getEnchantLevel(double progress) {
    int index = this.ordinal();
    return (int)MathHelper.lerp(progress, enchantLevel.get(index),
                                enchantLevel.get(index + 1));
  }
  ...
  public double getCommonEquipment(double progress) {
    int index = this.ordinal();
    return (double)MathHelper.lerp(progress, commonEquipment.get(index),
  ...
  public double getRareEquipment(double progress) {
    int index = this.ordinal();
    return (double)MathHelper.lerp(progress, rareEquipment.get(index),
  ...
  public double getShieldChance(double progress) {
    int index = this.ordinal();
    return (double)MathHelper.lerp(progress, shieldChance.get(index),
