...
import static org.codeberg.zenxarch.zombies.entity.effect.ZombieEffect.spawnParticles;
...
import org.codeberg.zenxarch.zombies.entity.effect.*;
...
public final class ZombieVariantGenerator implements DynamicRegistryInitializer<ZombieVariant> {
  ...
  @Override
  public void bootstrap(Registerable<ZombieVariant> registry) {
  ...
  @Override
  public RegistryKey<? extends Registry<ZombieVariant>> getRegistryKey() {
    return ZombieRegistryKeys.ZOMBIE_VARIANT;
  }
