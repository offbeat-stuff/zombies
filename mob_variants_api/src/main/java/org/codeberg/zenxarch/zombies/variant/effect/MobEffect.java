package org.codeberg.zenxarch.zombies.variant.effect;
...
import org.codeberg.zenxarch.zombies.variant.effect.pair.ConvertToEntityTypeEffect;
import org.codeberg.zenxarch.zombies.variant.effect.pair.DefaultMobEffect;
...
import org.codeberg.zenxarch.zombies.variant.effect.pair.SwapMobEffect;
import org.codeberg.zenxarch.zombies.variant.effect.single.FreezeEffect;
import org.codeberg.zenxarch.zombies.variant.effect.single.IgniteEffect;
import org.codeberg.zenxarch.zombies.variant.effect.single.SpawnParticleEffect;
